---
layout: post
title: "Research Visit at Swinburne University of Technology, Melbourne"
date: 2025-09-21 07:59:00+0700
inline: false
related_posts: false
---
...
Overall, this fellowship has been an exceptionally productive and inspiring experience. It allowed me to initiate new research projects, expand my technical skills in JWST and ASKAP data analysis, and form long-lasting collaborations with researchers in Australia. The visit also strengthened my international presence as an early-career researcher and provided valuable teaching and outreach experience. I am deeply grateful for the support that made this visit possible and look forward to continuing the projects and collaborations that have emerged from it.
Photos documenting my research activities and visits during the fellowship are attached at the end of this report.


<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/31_swinburne/01.jpg" title="group" class="img-fluid rounded z-depth-1" %}
        <p class="mt-2 text-muted">Sharing my research of galaxy clusters at CAS (Center for Astrophysics and Supercomputing) Colloquium at Swinburne University of Technology.</p>
    </div>
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/31_swinburne/02.jpg" title="group" class="img-fluid rounded z-depth-1" %}
        <p class="mt-2 text-muted">Delivering a talk on multiwavelength studies of brightest cluster galaxies to faculty members and students at Macquarie University. (</p>
    </div>
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/31_swinburne/03.jpg" title="astro" class="img-fluid rounded z-depth-1" %}
        <p class="mt-2 text-muted">Presenting an overview of my ongoing collaborative projects on galaxy clusters to researchers and graduate students at the University of Melbourne.</p>
    </div>
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/31_swinburne/04.jpg" title="astro" class="img-fluid rounded z-depth-1" %}
        <p class="mt-2 text-muted">Presenting my research on radio properties of galaxy clusters to researchers and staff at ATNF headquarters.</p>
    </div>
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/31_swinburne/05.jpg" title="astro" class="img-fluid rounded z-depth-1" %}
        <p class="mt-2 text-muted">Exploring the historic State Library Victoria, a cultural and architectural centerpiece of Melbourne, during my free time on weekends.</p>
    </div>
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/31_swinburne/06.jpg" title="astro" class="img-fluid rounded z-depth-1" %}
        <p class="mt-2 text-muted">Visiting one of Australia’s most iconic landmarks during my stay, with its distinctive architecture overlooking Sydney Harbour.</p>
    </div>
</div>